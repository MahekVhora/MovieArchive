...
// 1) PASTE_YOUR_TMDB_KEY_HERE  ← paste it between the quotes, replacing the placeholder.
//    Use the "API Key (v3 auth)" from themoviedb.org → Settings → API.
export const TMDB_API_KEY = '2923ccd110279961af46e0201491dd3b'
...
//    The first part is normal text, the second part is shown in italics.
   export const TITLE_PLAIN = 'Movies and'
   export const TITLE_ITALIC = 'Shows'
